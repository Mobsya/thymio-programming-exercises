...
This archive contains the document thymio-aseba-projects-en.pdf, which
describes the projects in great detail, and a directory programs with
the source code of the Aseba programs for the projects.
