\chapter{How Fast is the Thymio-II?}\label{c.fast}
...
center button causes a transition to state \bu{off}.
\end{itemize}
...
\section{Setting the power from the Thymio-II}
...
whenever the value of \p{motor} is changed. The assignment of power
...
The subroutine \p{set\_circle\_leds} consists of statements of the form:
