\chapter{The Cat Catches the Mouse}\label{c.cat}
...
\item \p{SCAN}: The power of motors during the left and right search.
...
\p{DETECTION} which defines the threshold for detection. You may want to
